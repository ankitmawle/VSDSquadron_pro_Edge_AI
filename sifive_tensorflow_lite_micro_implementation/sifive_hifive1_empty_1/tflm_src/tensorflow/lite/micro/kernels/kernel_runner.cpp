...
TfLiteStatus KernelRunner::Invoke() {
  ...
  if (registration_.invoke == nullptr) {
    printf("TFLMRegistration missing invoke function pointer!");
    return kTfLiteError;
  }
...
TfLiteStatus KernelRunner::Reset() {
  ...
  if (registration_.reset == nullptr) {
    printf("TFLMRegistration missing reset function pointer!");
    return kTfLiteError;
  }
...
TfLiteStatus KernelRunner::Free() {
  ...
  if (registration_.free == nullptr) {
    printf("TFLMRegistration missing free function pointer!");
    return kTfLiteError;
  }
